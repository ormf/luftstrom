...
(length (cl-boids-gpu::bs-positions *curr-boid-state*))

(sort
 (loop for x across (cl-boids-gpu::bs-life *curr-boid-state*)
       for idx from 0 by 16
       collect (list (aref (cl-boids-gpu::bs-positions *curr-boid-state*) idx)
                     (aref (cl-boids-gpu::bs-positions *curr-boid-state*) (1+ idx))
                     x))
 #'< :key #'first)


(coerce (cl-boids-gpu::bs-positions *curr-boid-state*) 'list)
