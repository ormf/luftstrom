...
at num."
  (let ((curr-bs-state (ou:ucopy *curr-boid-state*)))
    ...
    (setf (slot-value curr-bs-state 'cl-boids-gpu::maxlife) (cl-boids-gpu::maxlife *bp*))
    (setf (slot-value curr-bs-state 'cl-boids-gpu::lifemult) (cl-boids-gpu::lifemult *bp*))
