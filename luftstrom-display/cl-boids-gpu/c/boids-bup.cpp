...
// obstacle is within the reach of the board-position (the respective
// bit is set to 1). Checking this in get_closest_obst_idx reduces
// to checking all bits in the obstacles of the board-idx of a boid
...
__kernel void boids(__global float4* pos, 
                    ...
                    __constant float* obstacles_multiplier,
                    int num_obstacles,
                    int clock,
                    int maxidx,
                    float length,
