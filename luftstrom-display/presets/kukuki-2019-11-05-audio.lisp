...
:ampfn (* (sign) (n-exp y 1 0.5) (m-exp-zero (mc-ref 16) 0.01 1))
...
:synth 0
:pitchfn (n-exp y 0.5 1)
:ampfn (* (sign) (m-exp-zero (mc-ref 16) 0.01 1))
...
:ampfn (* (sign) (m-exp-zero (mc-ref 16) 0.01 1) (+ 0.1 (random 0.1)))
...
:ampfn (* (sign) (m-exp-zero (mc-ref 16) 0.01 1) (+ 0.1 (random 0.8)))
...
:decaystartfn 0.001
:decayendfn 0.002
:lfofreqfn (* 1 (hertz (m-lin (mc-ref 2) 31 55))
              (n-exp-dev (m-lin (mc-ref 3) 0 1) 1.5))
:xposfn x
:yposfn y
:wetfn (m-lin (mc-ref 8) 0 1)
...
:decaystartfn 0.001
:decayendfn 0.02
:lfofreqfn (* (expt (round (* 16 y)) (n-lin x 1 (m-lin (mc-ref 1) 1 1.5)))
              (hertz (m-lin (mc-ref 2) 31 55)))
:xposfn x
:yposfn y
:wetfn (m-lin (mc-ref 8) 0 1)
...
:decaystartfn 5.0e-4
:decayendfn 0.002
:lfofreqfn (* (m-exp (mc-ref 4) 0.25 1) (r-exp 200 200))
:xposfn x
:yposfn y
:wetfn (m-lin (mc-ref 8) 0 1)
:filtfreqfn (n-exp y 1000 10000)
