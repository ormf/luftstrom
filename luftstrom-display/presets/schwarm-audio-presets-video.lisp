...
:decay-startfn 0.5
:decay-endfn 0.06
:lfo-freqfn (* (n-exp-dev (m-lin (player-cc tidx 100) 0 1) 0.5)
               (n-exp y 500 1000))
:x-posfn x
:y-posfn y
:wetfn 1
...
(digest-audio-args-preset
'(:p1 0
:p2 (+ (m-lin (nk2-ref 20) 0 0.5) (n-lin y 0.3 0.5))
:p3 0
:p4 0
:pitchfn p2
:ampfn (* (m-exp-zero (player-cc tidx 7) 0.01 1) (sign) (n-exp p2 0.7 0.35))
:durfn (m-exp (nk2-ref 16) 0.001 0.5)
:suswidthfn 0.3
:suspanfn 0
:decay-startfn 0.03
:decay-endfn 0.05
:lfo-freqfn (* 48 (expt 2 (+ 2 (random 1))))
:x-posfn (- (* x 2) 1)
:y-posfn y
:wetfn (m-lin (nk2-ref 22) 0 1)
:filt-freqfn 20000
:bp-freq (m-exp (nk2-ref 21) 100 10000)
:bp-rq (m-exp (nk2-ref 19) 10 0.01))
...
:decay-startfn 0.01
:decay-endfn 0.06
:lfo-freqfn (let ((pwidth (round (m-lin (player-cc tidx 100) -10 16))))
              (* (expt 1.1 (random 1.0))
...
:p4 0
:pitchfn (+ p2 (n-exp y 0.4 1.08))
:ampfn (progn (* (sign) (nk2-ref 7) (n-exp y 1 0.5)))
:durfn 0.5
:suswidthfn 0
:suspanfn (random 1.0)
:decay-startfn 5.0e-4
...
:p3 0
:p4 0
:pitchfn (* (m-lin (nk2-ref 22) 0.5 0.7) (n-exp-dev (random 1.0) 0.99))
:ampfn (* (sign) (m-exp-zero (nk2-ref 7) 0.01 1))
:durfn 1
:suswidthfn (m-lin (nk2-ref 20) 0 0.6)
:suspanfn (m-lin (nk2-ref 19) 0 0.04)
:decay-startfn (m-lin (nk2-ref 21) 0.01 0.5)
:decay-endfn (m-lin (nk2-ref 21) 0.01 0.6)
:lfo-freqfn 0.01
:x-posfn (- (* x 2) 1)
:y-posfn y
:wetfn 1
:filt-freqfn (m-exp (nk2-ref 23) 100 20000))
...
:decay-startfn 5.0e-4
:decay-endfn 0.002
:lfo-freqfn (hertz (ewi-nlin tidx 1 40))
:x-posfn x
:y-posfn y
:wetfn (m-lin (nk2-ref 23) 0 1)
:filt-freqfn (n-exp y 1000 10000)
...
:decay-startfn 0.001
:decay-endfn 0.002
:lfo-freqfn (* 1 (hertz (m-lin (nk2-ref 17) 31 55))
               (n-exp-dev (m-lin (nk2-ref 18) 0 1) 1.5))
:x-posfn x
:y-posfn y
:wetfn (m-lin (nk2-ref 23) 0 1)
