...
:ampfn (progn
        (* (/ v 20) (m-exp-zero (player-cc tidx 7) 0.01 1) (sign)
           (n-exp y 3 1.5)))
:durfn 0.01
:suswidthfn 0
:suspanfn 0
...
:durfn (m-exp (player-cc tidx 65) 0.1 0.5)
:suswidthfn 0
:suspanfn (m-lin (* 127/20 (player-cc tidx 100)) 1 0)
:decay-startfn 5.0e-4
:decay-endfn 0.002
:lfo-freqfn (* 1 (r-exp 50 50))
:x-posfn x
:y-posfn y
:wetfn 1
:filt-freqfn 20000)
