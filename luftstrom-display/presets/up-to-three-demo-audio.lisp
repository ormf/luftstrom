...
:decaystartfn 5.0e-4
:decayendfn 0.002
:lfofreqfn (* (m-exp (player-note tidx) 1 10) 10)
:xposfn x
:yposfn y
...
:decaystartfn 5.0e-4
:decayendfn 0.002
:lfofreqfn (* (n-exp-dev (n-ewi-note (player-note tidx)) 1.5) 50)
:xposfn x
:yposfn y
:wetfn (m-lin (aref *cc-state* *nk2-chan* 23) 0 1)
:filtfreqfn 20000)
...
:yposfn y
:wetfn (m-lin (aref *cc-state* *nk2-chan* 23) 0 1)
:filtfreqfn (m-exp (aref *cc-state* *nk2-chan* 22) 100 20000))
...
:synth 0
:pitchfn (n-exp y 0.5 1)
:ampfn (* (sign) (m-exp-zero (player-cc tidx 7) 0.01 1))
...
:pitchfn (+ p2 (n-exp y 0.4 1.08))
:ampfn (progn
        (* (sign) 0.5 (m-exp-zero (player-cc tidx 7) 0.01 1) (n-exp y 0.5 1)))
:durfn (m-exp (player-cc tidx 100) 0.1 0.5)
:suswidthfn 0.1
:suspanfn 0
:decaystartfn 5.0e-4
...
:synth 0
:pitchfn (* (n-exp y 0.7 1.3) 0.63951963)
:ampfn (* (sign) 0.5 (m-exp-zero (player-cc tidx 7) 0.01 1) (n-exp y 1 0.5))
:durfn p1
:suswidthfn (+ 0.1 (random 0.3))
:suspanfn (random p1)
:decaystartfn 5.0e-4
...
:filtfreqfn (* (n-exp y 1 2) (m-exp (nk2-ref 23) 100 10000)))
...
:yposfn y
:wetfn 1
:filtfreqfn (m-exp (aref *cc-state* *nk2-chan* 23) 100 10000))
...
:wetfn 0.5
:filtfreqfn 20000
:bpfreq (m-exp (player-cc tidx 16) 100 5000)
:bprq (m-exp (player-cc tidx 17) 1 0.1))
...
:ampfn (* (sign) (m-exp-zero (player-cc tidx 7) 0.01 1) (r-exp 0.5 1))
...
:wetfn (m-lin (aref *cc-state* 4 23) 0 1)
:filtfreqfn 20000
:bpfreq (m-exp (aref *cc-state* 3 100) 200 5000)
:bprq 0.01)
...
:decaystartfn 0.01
:decayendfn 0.06
:lfofreqfn (* (expt 1.1 (random 1.0)) (hertz (m-lin (player-note 4) 30 120)))
:xposfn x
:yposfn y
:wetfn (m-lin (aref *cc-state* 4 23) 0 1)
...
:decaystartfn 0.01
:decayendfn 0.06
:lfofreqfn (* (/ (round (* 16 y)) 16) (m-exp (aref *cc-state* 4 18) 1 2) 1500)
:xposfn x
:yposfn y
:wetfn (m-lin (aref *cc-state* 4 23) 0 1)
:filtfreqfn (m-exp y 1000 20000))
...
:synth 0
:pitchfn 0.6
:ampfn (m-exp-zero (nk2-ref 7) 0.01 1.0)
:durfn 0.8
:suswidthfn 0
:suspanfn 0
:decaystartfn 0.001
...
:synth 0
:pitchfn (n-exp y 0.4 1.2)
:ampfn (* (sign) 0.125 (m-exp-zero (player-cc tidx 7) 0.01 1)
          (+ 0.1 (random 0.6)))
:durfn (n-exp y 0.8 0.16)
:suswidthfn 0.1
:suspanfn 0.3
...
:synth 0
:pitchfn (+ 0.5 (* 0.1 y))
:ampfn (* 0.05 (sign) (m-exp (player-cc tidx 7) 0.01 1))
:durfn 0.1
:suswidthfn (case tidx (1 1) (otherwise 0))
:suspanfn 0
:decaystartfn 0.5
...
:decaystartfn 5.0e-4
:decayendfn 0.002
:lfofreqfn (* (m-exp (aref *cc-state* *nk2-chan* 21) 1 10) (r-exp 50 80))
:xposfn x
:yposfn y
:wetfn (m-lin (aref *cc-state* *nk2-chan* 23) 0 1)
:filtfreqfn 20000)
...
:wetfn (m-lin (aref *cc-state* *nk2-chan* 23) 0 1)
:filtfreqfn 20000
:bpfreq (m-exp (aref *cc-state* *nk2-chan* 18) 100 10000)
:bprq (m-exp (aref *cc-state* *nk2-chan* 19) 1 0.01))
...
:bprq (m-lin (aref *cc-state* *nk2-chan* 22) 5 0.01))
...
:ampfn (* (sign) (m-exp-zero (player-cc tidx 7) 0.01 4) (+ 0.1 (random 0.6)))
:durfn p1
:suswidthfn 0.1
:suspanfn 0.3
:decaystartfn 0.001
...
:ampfn (* (sign) (m-exp-zero (player-cc tidx 7) 0.01 1) (+ 0.4 (random 0.6)))
:durfn p1
:suswidthfn 0
:suspanfn 0.3
:decaystartfn 0.001
